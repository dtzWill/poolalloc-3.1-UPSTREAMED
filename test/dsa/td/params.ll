...
;RUN: dsaopt %s -dsa-steens -analyze -check-same-node=func:a1:0,func:b1:0,func:mem2:0,func:mem1:0,func:r1,func:r2
;RUN: dsaopt %s -dsa-steens -analyze -check-same-node=test:temp2:0,test:a2:0,test:temp1:0,test:temp:0,test:b2:0
;RUN: dsaopt %s -dsa-steens -analyze -check-same-node=test:a2,test:b2,test:temp2
